...
bool check_damage(character &c, enemies &e,Clock colission_clock){
	...
	if ((sqrt(pow(v.x,2)+pow(v.y,2))<90)&&(colission_clock.getElapsedTime().asMilliseconds()>500)&&check){
